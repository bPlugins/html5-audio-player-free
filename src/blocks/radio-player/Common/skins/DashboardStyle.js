        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center space-x-3">
                <button data-plyr="play"
                    class="plyr___control play-icon w-12 h-12 border-none rounded-xl flex items-center justify-center transition-all duration-200 shadow-md hover:shadow-lg"
                >
                ...
                <div class="flex flex-col">
                    <div class="flex items-center space-x-2 no-thumb">
                        <button class="leading-none cursor-pointer text-gray-500 hover:bg-transparent border-none plyr___control" aria-label="Mute" data-plyr="mute">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="svg-icon lucide lucide-volume2 icon--not-pressed">
                                <polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"></polygon>
                                <path d="M15.54 8.46a5 5 0 0 1 0 7.07"></path>
                                <path d="M19.07 4.93a10 10 0 0 1 0 14.14"></path>
                            </svg>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="svg-icon lucide lucide-volume-x icon--pressed">
                                <polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"></polygon>
